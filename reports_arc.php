...
$grid["export"] = array("filename"=>"Archive_Working_Tools_Reports_".date("dmYHi"), "heading"=>"LIMAK KOSOVO INTERNATIONAL AIRPORT J.S.C.<br>Security and Screening Unit<br><br>Screening - Report  ".date("d.m.Y H:i"), "orientation"=>"landscape", "paper"=>"a2");

// for excel, sheet header
$grid["export"]["sheetname"] = "Archive_Working_Tools_Reports";
...
$g->set_actions(array(
				...
				$g->select_command = "SELECT * FROM shenimet_table WHERE archive = 1";
...
<div style="background:url('../images/tasks.png') no-repeat center center; background-size: cover;" width="100%" border="0" cellpadding="0" cellspacing="0" >
    <table width="100%" id="header">
        ...
        <td width="50%" align="center"><div class="titllinalt" style="font-size: 19px">Archived Records<br /><br /> <span style="font-size:20px">Security and Screening Unit</span> </div></td>
...
<div style="bottom:0; width:100%; height:25px; background:#61A24D; vertical-align:middle; text-align: left; color: white; padding-top:5px"> &nbsp; &copy; 
